...
The additional columns from `tidy_categroical()` can be used to group together terms from the same categorical variable by setting `colour = variable`
